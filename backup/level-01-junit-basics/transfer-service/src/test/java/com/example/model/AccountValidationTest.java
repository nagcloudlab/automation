...
class AccountValidationTest {
    ...
    class CreditValidationTests {
        ...
        void shouldThrowExceptionForNegativeCredit() {
            ...
            assertEquals("Amount to credit should be positive", exception.getMessage());
        }
     ...
     */
    @Test
    @DisplayName("Should throw IllegalArgumentException (not other types)")
    void shouldThrowCorrectExceptionType() {
        // Should NOT throw RuntimeException (base class)
        // Should NOT throw NullPointerException
        // Should throw exactly IllegalArgumentException

        Exception exception = assertThrows(
            IllegalArgumentException.class,  // Exact type expected
            () -> account.debit(-100.0)
        );

        // Verify it's exactly IllegalArgumentException, not a subclass
    ...
    void multipleInvalidOperationsShouldAllThrow() {
        assertAll("All invalid operations should throw",
            () -> assertThrows(IllegalArgumentException.class, () -> account.debit(-1)),
            () -> assertThrows(IllegalArgumentException.class, () -> account.debit(0)),
            () -> assertThrows(IllegalArgumentException.class, () -> account.debit(99999)),
